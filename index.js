...
// Sample hotels data (paste hotels array here from the gist link)
let products = [
  {
    id: 1,
...
// Step 7: Send all hotels
app.get('/products', (req, res) => {
  res.json({ products });
});

// Endpoint 1: Sort products by popularity (ratings)
app.get('/products/sort/popularity', (req, res) => {
  let sortedProducts = [...products].sort((a, b) => b.rating - a.rating);
  res.json({ products: sortedProducts });
});

// Endpoint 2: Sort products by price (high-to-low)
app.get('/products/sort/price-high-to-low', (req, res) => {
  let sortedProducts = [...products].sort((a, b) => b.price - a.price);
  res.json({ products: sortedProducts });
});

// Endpoint 3: Sort products by price (low-to-high)
...
app.get('/products/filter/brand', (req, res) => {
  const { brand } = req.query.toLowerCase();
...
app.get('/products/filter/os', (req, res) => {
  const { os } = req.query.toLowerCase();
...
// Endpoint 8: Filter products by price (less than or equal to specified price)
